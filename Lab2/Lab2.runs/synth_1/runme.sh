...
HD_PWD='C:/Users/Dustin.Mock/code/ece383/Lab2/Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_datapath_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab2_datapath_tb.tcl
