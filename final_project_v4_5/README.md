...
*   **Minimum Functionality (C-Level):**
    1.  A hardcoded 16x16 maze map to the HDMI output.
    3.  The on-board buttons (BTNU/BTND) move the player forward and backward.
...
*   **`scopeFace`:** The core raycasting engine, based on these tutorials: https://youtu.be/NbSee-XM7WA?si=MF5N0uI2QQE4T2Vd and https://youtu.be/3FqDZcCd-g8?si=tsIpDQRcEcJSS0HG.
...
![image1](images/top half screen bug, working floor and sky.jpg)
![image2](images/left_side_bar.jpg)
![image3](images/full_screen_chaos.jpg)

My project did not end up rendering, despite many (many!) hours of work. In hindsight, I should have chosen a simpler pseudo-3D engine to implement, I think adapting DDA raycasting, while cool and forced me to learn a lot, was out of my depth. I also should have spent more time implementing UART for debugging and such. Instead, I just tried to get it to work with hopes I would be able to debug from the data. However, towards the end it took 45 minutes to compile and generate each bitstream.
...
I would not recommend doing any of this though since you won't be able to see anything beyond the linked images.