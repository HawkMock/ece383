namespace eval ::optrace {
  variable script "X:/final_project_v4.runs/impl_1/system_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir X:/final_project_v4.cache/wt [current_project]
  set_property parent.project_path X:/final_project_v4.xpr [current_project]
  set_property ip_repo_paths C:/Digilent/vivado-library [current_project]
  update_ip_catalog
  set_property ip_output_repo X:/final_project_v4.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet X:/final_project_v4.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files X:/final_project_v4.srcs/sources_1/bd/system/system.bd
  set_property used_in_synthesis 0 [get_files -all x:/final_project_v4.gen/sources_1/bd/system/ip/system_mig_7series_0_1/system_mig_7series_0_1/user_design/constraints/system_mig_7series_0_1.xdc]
  set_property used_in_implementation 0 [get_files -all x:/final_project_v4.gen/sources_1/bd/system/ip/system_mig_7series_0_1/system_mig_7series_0_1/user_design/constraints/system_mig_7series_0_1.xdc]
  set_property used_in_synthesis 0 [get_files -all x:/final_project_v4.gen/sources_1/bd/system/ip/system_mig_7series_0_1/system_mig_7series_0_1/user_design/constraints/system_mig_7series_0_1_ooc.xdc]
  set_property used_in_implementation 0 [get_files -all x:/final_project_v4.gen/sources_1/bd/system/ip/system_mig_7series_0_1/system_mig_7series_0_1/user_design/constraints/system_mig_7series_0_1_ooc.xdc]
...
OPTRACE "link_design" START { }
  set_param project.isImplRun true
  link_design -top system_wrapper -part xc7a200tsbg484-1 
